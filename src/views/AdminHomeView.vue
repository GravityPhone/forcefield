...
// Org-level setup only (2026-07-21 rework). Day-to-day controls live where
// they're used: posting on /bulletin, Board options on /leaderboard, Feed
// options on /activity, and turf cutting on the Turf tab.
</script>
