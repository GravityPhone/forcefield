...
// A "Someone else?" button used to sit under the roster, opening a county-roll
// search for whoever answered but isn't on this door's list (2026-07-26, gone
// the same day at the user's call — "it's totally superfluous, we could just do
// that at the top like normal"). The search box at the top of Talk already
// finds any person in the county and opens their door, which is the normal way
// in; a second search under the names was one control too many on the screen a
// canvasser reads at a stranger's porch.
